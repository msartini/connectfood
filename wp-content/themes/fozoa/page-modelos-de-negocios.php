...
<div id="content" class="clearfix row-fluid page-modelos-de-negocios">
          ...
          <div class="span8">
            ...
            <div class="pagecontent">
              ...
              <?php if ( $post->post_name == "segmentos-de-atuacao") : ?>
                ...
                <?php endif; ?>
              <?php endif; ?>
              <div class="boxes-modelo-de-negocios">
                <div class="row-fluid">
                  <section class="span4">
                    <header class="bg-negocios">
                      <h4 class="uppercase">
                        <span><?php echo get_field('modelo_campo_1_titulo'); ?></span>
                      </h4>
                    </header>
                    <footer class="desc-content">
                      <?php echo short_text('', get_field('modelo_campo_1_descricao'), 15); ?>
                    </footer>
                  </section>
                  <section class="span4">
                    <header class="bg-negocios">
                      <h4 class="uppercase">
                        <span><?php echo get_field('modelo_campo_2_titulo'); ?></span>
                      </h4>
                    </header>
                    <footer class="desc-content">
                      <?php echo short_text('', get_field('modelo_campo_2_descricao'), 15); ?>
                    </footer>
                  </section>
                  <section class="span4">
                    <header class="bg-negocios">
                      <h4 class="uppercase">
                        <span><?php echo get_field('modelo_campo_3_titulo'); ?></span>
                      </h4>
                    </header>
                    <footer class="desc-content">
                      <?php echo short_text('', get_field('modelo_campo_3_descricao'), 15); ?>
                    </footer>
                  </section>
                </div>
                <div class="row-fluid">
                  <section class="span4">
                    <header class="bg-negocios">
                      <h4 class="uppercase">
                        <span><?php echo get_field('modelo_campo_4_titulo'); ?></span>
                      </h4>
                    </header>
                    <footer class="desc-content">
                       <?php echo short_text('', get_field('modelo_campo_4_descricao'), 15); ?>
                    </footer>
                  </section>
                  <section class="span4">
                    <header class="bg-negocios">
                      <h4 class="uppercase">
                        <span><?php echo get_field('modelo_campo_5_titulo'); ?></span>
                      </h4>
                    </header>
                    <footer class="desc-content">
                       <?php echo short_text('', get_field('modelo_campo_5_descricao'), 15); ?>
                    </footer>
                  </section>
                  <section class="span4">
                    <header class="bg-negocios">
                      <h4 class="uppercase">
                        <span><?php echo get_field('modelo_campo_6_titulo'); ?></span>
                      </h4>
                    </header>
                    <footer class="desc-content">
                       <?php echo short_text('', get_field('modelo_campo_6_descricao'), 15); ?>
                    </footer>
                  </section>
                </div>
              </div>
