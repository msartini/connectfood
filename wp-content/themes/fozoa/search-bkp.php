<?php get_header(); ?>
			...
			<div id="content" class="clearfix row-fluid">
				...
				<div id="main" class="span8 clearfix" role="main">
					...
					<div class="page-header"><h1><span><?php _e("Search ","bonestheme"); ?><?php echo $wp_query->post_count; ?><?php _e("Results for","bonestheme"); ?>:</span> <?php echo esc_attr(get_search_query()); ?></h1></div>
					<?php if (have_posts()) : ?>
