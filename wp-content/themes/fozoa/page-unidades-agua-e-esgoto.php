            ...
            <div class="pagecontent">
              <div class="listaunidades clearfix">
                  <?php
                              ...
                              array('taxonomy' => 'segmentos_category', 'field' => 'slug','terms' => 'agua')), 'post_type' => 'unidades', 'showposts' => -1);
                  ?>
                  <?php $the_query = new WP_Query( $args ); ?>
                  <?php if($the_query->have_posts() ) : ?>
                    ...
                    <?php while ( $the_query->have_posts() ) : $the_query->the_post(); ?>
                      <?php $linha++; ?>
                      <?php $link = get_field('unidade_link'); ?>
                      ...
                      <li class="span4 <?php echo ($linha % 3) ? "odd" : ""; ?>">
                        <div class="image">
                          ...
                          <a  <?php echo ($link=='')?'': 'href="'. $link . '"';?> ><img src="<?php echo $src; ?>" alt=""></a>
                        </div>
                        <div class="title ">
                          <a <?php echo ($link=='')?'': 'href="'. $link . '"';?> ><?php echo get_the_title(); ?></a>
