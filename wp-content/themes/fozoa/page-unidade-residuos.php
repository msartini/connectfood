      ...
      <article id="post-<?php the_ID(); ?>" <?php post_class('clearfix'); ?> role="article" itemscope itemtype="http://schema.org/BlogPosting">
        ...
        <section class="post_content clearfix" itemprop="articleBody">
          <div class="span4">
            <div class="side-menu">
              <div class="list-menu">
                <?php $menus = get_terms( 'nav_menu', array( 'hide_empty' => true, 'slug' => 'residuos' ) );?>
          ...
          <div class="span8 unidade-agua-esgoto">
                  ...
                  <div class="content-submenu">
                   ...
                   <div class="content-inner-bottom">
                      ...
                      $args = array('post_type' => 'empresas', 'tax_query' => array(
                                      ...
                                      array('taxonomy' => 'segmentos_category', 'field' => 'slug','terms' => 'residuos')
                                    ), 'showposts' => -1);
                      ?>
            ...
            <div class="maisunidades">
              <div class="row-fluid">
                <div class="span3">                  
                  <h3 class="text-red"><a href="<?php echo site_url(); ?>/areas-de-atuacao/residuos/unidades-residuos/" class="text-red">Mais unidades</a></h3>                                                                        
                </div>
                <div class="span9 title-bg-diagonal">
                  <span class="bg-diagonal"></span>
                </div>
              ...
              <?php
                ...
                array('taxonomy' => 'segmentos_category', 'field' => 'slug','terms' => 'residuos')), 'showposts' => 2);
              ?>
              <?php $recno = 0; ?>
              <?php $the_query = new WP_Query( $args ); ?>
              <?php if($the_query->have_posts() ) : ?>
