            ...
            <div class="pagecontent">
              <div class="listaunidades clearfix">
                  <?php
                              ...
                              array('taxonomy' => 'segmentos_category', 'field' => 'slug','terms' => 'residuos')), 'post_type' => 'unidades', 'showposts' => -1);
                  ?>
                  <?php $the_query = new WP_Query( $args ); ?>
                  <?php if($the_query->have_posts() ) : ?>
                    ...
                    <?php while ( $the_query->have_posts() ) : $the_query->the_post(); ?>
                      ...
                      <li class="span4 <?php echo ($linha % 3) ? "odd" : ""; ?>">
                        <div class="image">
                          ...
                          <a href="<?php echo site_url(); ?>/areas-de-atuacao/residuos/unidade-residuos/?unidade=<?php echo $post->post_name; ?>"><img src="<?php echo $src; ?>" alt=""></a>
                        </div>
                        <div class="title ">
                          <a href="<?php echo site_url(); ?>/areas-de-atuacao/residuos/unidade-residuos/?unidade=<?php echo $post->post_name; ?>"><?php echo get_the_title(); ?></a>
