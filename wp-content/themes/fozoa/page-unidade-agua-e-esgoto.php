      ...
      <article id="post-<?php the_ID(); ?>" <?php post_class('clearfix'); ?> role="article" itemscope itemtype="http://schema.org/BlogPosting">
        ...
        <section class="post_content clearfix" itemprop="articleBody">
          <div class="span4">
            <div class="side-menu">
              <div class="list-menu">
                <?php $menus = get_terms( 'nav_menu', array( 'hide_empty' => true, 'slug' => 'agua-e-esgoto' ) );?>
          ...
          <?php
                      ...
                      array('taxonomy' => 'segmentos_category', 'field' => 'slug','terms' => 'agua')), 'showposts' => 1);
          ?>
          ...
          <div class="span8 unidade-agua-esgoto">
              ...
              <?php while ( $the_query->have_posts() ) : $the_query->the_post(); ?>
                ...
                <div class="row">
                  <div class="clearfix span12">
                    <span class="bg-agua-e-esgoto"></span>
                  </div>
                </div>
                <?php $unidade_descricao = get_post_meta($post->ID, 'unidade_descricao', true); ?>
                <h3 class="text-blue"><?php the_title(); ?> <?php echo $unidade_descricao; ?></h3>
                ...
                <div class="main-content">
                  ...
                  <div class="content-submenu">
                    <div class="row-fluid">
                      <div class="span3">
                        <h3 class="text-blue">Ficha Técnica</h3>
                      </div>
                   ...
                   <div class="content-inner-bottom">
                      ...
                      <!-- Empresas - Clientes -->
                      <?php
                        $terms = get_terms("empresas_category");
                        $terms_param = array();
                      ...
                      array('taxonomy' => 'empresas_category', 'field' => 'slug','terms' => $terms_param)), 'showposts' => -1);
                      ?>
            ...
            <div class="maisunidades">
              <div class="row-fluid">
                <div class="span3">
                  <h3 class="text-red"><a href="<?php echo site_url(); ?>/areas-de-atuacao/agua-e-esgoto/unidades-agua-e-esgoto" class="text-red">Mais unidades</a></h3>
                                                                        
                </div>
                <div class="span9 title-bg-diagonal">
                  <span class="bg-diagonal"></span>
                </div>
                <!--<div class="span3 subtitle-todas-unidades">
                  <span class="text-gray pull-right">Ver todas as unidades</span>
                </div>
              -->
              </div>
              ...
              <?php
                ...
                array('taxonomy' => 'segmentos_category', 'field' => 'slug','terms' => 'agua')), 'showposts' => 2);
              ?>
              <?php $recno = 0; ?>
              <?php $the_query = new WP_Query( $args ); ?>
              <?php if($the_query->have_posts() ) : ?>
